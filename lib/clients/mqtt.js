...
class MqttClient extends EventEmitter {
  ...
  start () {
    ...
    this.client.on('message', (topic, message) => {
     log.debug(`NBM_A1:Here msg: ` + message.toString());
      ...
      log.debug(`NBM_A1b:Here msg: ` + message.toString());
//log.debug(`NBM0: sent property`, {propertyName: parsed.property.name, propertyValue: parsed.property.value});
